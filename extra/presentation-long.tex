...
\begin{block}{No sobrevive sin condiciones}``Todo conocimiento desaparece'': con $\tau_{syn}>0$ el propio paper obtiene $\bar X_\ell^*>0$.\end{block}
...
\sourcefoot{Proposiciones 5, 10--11 y 15, pp. 21--27 y 32.}\end{frame}
\end{document}
